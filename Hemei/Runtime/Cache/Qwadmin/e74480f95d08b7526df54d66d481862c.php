						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									...
									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-11"> 所属导航 </label>
										<div class="col-sm-9">
											<input type="text" name="category" id="category" placeholder="导航ID" class="col-xs-10 col-sm-5" value="">
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">导航必须选择（每个导航只允许指定一个图片）。</span>
											</span>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div class="col-xs-12 col-sm-12"><?php echo UpImage("pic",562,374);?></div>
											<span class="help-inline col-xs-12 col-sm-12">
												<span class="middle">仅支持jpg、gif、png、bmp、jpeg，且小于1MB 分辨率562*374像素。</span>
											</span>
										</div>
									</div>
				...
				<div class="footer-inner">
					...
					<div class="footer-content">
						<span class="bigger-120">
							<small>Copyright &copy; 2016 <a href="http://www.hmsyxx.cn" target="_blank">和美网络</a> All Rights Reserved.</small>
						</span>
					</div>
