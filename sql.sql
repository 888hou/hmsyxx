...
CREATE TABLE IF NOT EXISTS `hm_article` (
...
CREATE TABLE IF NOT EXISTS `hm_auth_group` (
...
CREATE TABLE IF NOT EXISTS `hm_auth_group_access` (
...
CREATE TABLE IF NOT EXISTS `hm_auth_rule` (
...
DROP TABLE IF EXISTS `hm_devlog`;
CREATE TABLE IF NOT EXISTS `hm_devlog` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `hm_flash`;
CREATE TABLE IF NOT EXISTS `hm_flash` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `hm_links`;
CREATE TABLE IF NOT EXISTS `hm_links` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) NOT NULL,
  `url` varchar(255) NOT NULL,
...
DROP TABLE IF EXISTS `hm_log`;
CREATE TABLE IF NOT EXISTS `hm_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `hm_setting` (
